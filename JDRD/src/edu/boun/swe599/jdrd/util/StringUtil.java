...
public abstract class StringUtil {
    ...
    /**
     * Check whether the given String has no actual text. More specifically,
     * returns <code>true</code> if the string is <code>null</code>, or its
     * length is 0, or it contains whitespace only.
     *
     * @param str the String to check (may be <code>null</code>)
     * @return <code>true</code> if the String is <code>null</code>,or its
